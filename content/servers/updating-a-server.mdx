...
- [connection troubleshooting guide](/servers/server-not-showing)

**Sources**: [Official 1.0 patch notes](https://www.valheim.com/news/valheim-1-0-has-arrived-/), [September 11 hotfix](https://valheim.com/news/hotfix-1-0-10-1-0-12/), [1.0 FAQ](https://valheim.com/support/valheim-1-0-faq/), [Valheim dedicated-server guide](https://valheim.com/support/a-guide-to-dedicated-servers/), [Valheim save-system testing announcement](https://www.valheimgame.com/news/word-from-the-devs-summoning-our-champions-/), [Valve SteamCMD documentation](https://developer.valvesoftware.com/wiki/SteamCMD).
