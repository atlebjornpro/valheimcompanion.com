...
Valheim 1.0 launched September 9, 2026. This guide covers the currently documented server application and identifies launch-day details that still require rechecking.
...
Before updating, follow the [world backup and restore guide](/servers/world-backup-restore).
