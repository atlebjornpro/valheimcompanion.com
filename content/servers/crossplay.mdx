...
Players can still use player-hosted worlds where supported by the game. Check the installed platform's connection menu and current patch notes.
...
**Sources**: [Valheim 1.0 FAQ](https://valheim.com/support/valheim-1-0-faq/), [Valheim dedicated-server guide](https://valheim.com/support/a-guide-to-dedicated-servers/), [Valheim crossplay FAQ](https://valheim.com/support/crossplay-faq/), [Valheim 1.0 release announcement](https://www.valheimgame.com/news/valheim-has-a-release-date-/), [September hotfix announcement](https://valheim.com/news/hotfix-1-0-10-1-0-12/).
