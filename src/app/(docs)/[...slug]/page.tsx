...
const relatedMap: Record<string, { href: string; label: string }[]> = {
  ...
  "/world": [{ href: "/world/regions/meadows", label: "Start in Meadows" }, { href: "/bosses", label: "Boss guide" }, { href: "/valheim-1-0", label: "Valheim 1.0 release hub" }, { href: "/deep-north", label: "Deep North coverage" }],
  ...
  "/bosses": [{ href: "/bosses/eikthyr", label: "Start with Eikthyr" }, { href: "/world", label: "World and biome guide" }, { href: "/valheim-1-0", label: "Valheim 1.0 release hub" }],
