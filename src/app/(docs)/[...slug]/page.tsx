...
const relatedMap: Record<string, { href: string; label: string }[]> = {
  ...
  "/world/regions/ashlands": [{ href: "/world", label: "World guide" }, { href: "/bosses/fader", label: "Boss: Fader" }, { href: "/world/regions/mistlands", label: "Previous: Mistlands" }, { href: "/valheim-1-0", label: "What's next: Valheim 1.0" }],
  ...
  "/bosses/fader": [{ href: "/bosses", label: "Boss guide" }, { href: "/world/regions/ashlands", label: "Ashlands biome guide" }, { href: "/bosses/the-queen", label: "Previous: The Queen" }, { href: "/valheim-1-0", label: "What's next: Valheim 1.0" }],
};
