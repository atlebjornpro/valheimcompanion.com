...
const relatedMap: Record<string, { href: string; label: string }[]> = {
  "/patch-notes/v1-0-12": [{ href: "/patch-notes", label: "Patch notes" }, { href: "/patch-notes/v1-0-10", label: "All-platform hotfix" }, { href: "/valheim-1-0/achievements-cheats", label: "Achievement eligibility" }],
  "/patch-notes/v1-0-10": [{ href: "/patch-notes", label: "Patch notes" }, { href: "/patch-notes/v1-0-12", label: "Steam hotfix" }, { href: "/world/regions/deep-north", label: "Deep North" }],
  "/patch-notes/v1-0-release": [{ href: "/patch-notes", label: "Patch notes" }, { href: "/deep-north", label: "Deep North" }, { href: "/servers/updating-a-server", label: "Update a server" }],
  "/patch-notes": [{ href: "/updates", label: "Updates and known issues" }, { href: "/patch-notes/v1-0-12", label: "Hotfix 1.0.12" }, { href: "/patch-notes/v1-0-10", label: "Hotfix 1.0.10" }, { href: "/patch-notes/v1-0-release", label: "1.0 release" }],
  "/bosses/kall-fimbulbringer": [{ href: "/world/regions/deep-north", label: "Deep North biome" }, { href: "/deep-north", label: "Deep North guide" }, { href: "/bosses/fader", label: "Previous: Fader" }, { href: "/bosses", label: "Boss guide" }],
  "/world/regions/deep-north": [{ href: "/deep-north", label: "Deep North guide" }, { href: "/bosses/kall-fimbulbringer", label: "Boss: Kall Fimbulbringer" }, { href: "/world/regions/ashlands", label: "Previous: Ashlands" }, { href: "/world", label: "World guide" }],
  ...
  "/valheim-1-0/mods-compatibility": [{ href: "/valheim-1-0/preparation-checklist", label: "Preparation checklist" }, { href: "/servers/updating-a-server", label: "Update a server safely" }, { href: "/servers/world-backup-restore", label: "Back up and restore a world" }, { href: "/valheim-1-0/achievements-cheats", label: "Achievement eligibility" }],
  "/valheim-1-0/system-requirements-download-size": [{ href: "/valheim-1-0", label: "Valheim 1.0 release hub" }, { href: "/valheim-1-0/preparation-checklist", label: "Preparation checklist" }, { href: "/servers/server-requirements", label: "Dedicated-server requirements" }],
  "/valheim-1-0/playstation-5": [{ href: "/valheim-1-0", label: "Valheim 1.0 release hub" }, { href: "/servers/crossplay", label: "Crossplay configuration" }, { href: "/servers/best-server-hosting", label: "Compare server hosting" }, { href: "/valheim-1-0/achievements-cheats", label: "Achievement eligibility" }],
  "/valheim-1-0/nintendo-switch-2": [{ href: "/valheim-1-0", label: "Valheim 1.0 release hub" }, { href: "/servers/crossplay", label: "Crossplay configuration" }, { href: "/servers/best-server-hosting", label: "Compare server hosting" }, { href: "/valheim-1-0/system-requirements-download-size", label: "Download-size guidance" }],
  ...
  "/servers/existing-world-vs-new-world": [{ href: "/valheim-1-0", label: "Valheim 1.0 release hub" }, { href: "/deep-north", label: "Deep North guide" }, { href: "/servers/world-backup-restore", label: "Back up and restore a world" }],
  ...
  "/world/regions/mountain": [{ href: "/world", label: "World guide" }, { href: "/bosses/moder", label: "Boss: Moder" }, { href: "/world/regions/swamp", label: "Previous: Swamp" }, { href: "/world/regions/plains", label: "Next: Plains" }],
  "/world/regions/plains": [{ href: "/world", label: "World guide" }, { href: "/bosses/yagluth", label: "Boss: Yagluth" }, { href: "/world/regions/mountain", label: "Previous: Mountain" }, { href: "/world/regions/mistlands", label: "Next: Mistlands" }],
  "/world/regions/mistlands": [{ href: "/world", label: "World guide" }, { href: "/bosses/the-queen", label: "Boss: The Queen" }, { href: "/world/regions/plains", label: "Previous: Plains" }, { href: "/world/regions/ashlands", label: "Next: Ashlands" }],
  "/world/regions/ashlands": [{ href: "/world", label: "World guide" }, { href: "/bosses/fader", label: "Boss: Fader" }, { href: "/world/regions/mistlands", label: "Previous: Mistlands" }, { href: "/world/regions/deep-north", label: "Next: Deep North" }],
  "/bosses": [{ href: "/bosses/eikthyr", label: "Start with Eikthyr" }, { href: "/world", label: "World and biome guide" }, { href: "/progression/roadmap", label: "Progression roadmap" }],
  ...
  "/resources/taming": [{ href: "/resources/food-and-cooking", label: "Food and cooking guide" }, { href: "/world/regions/plains", label: "Plains biome guide" }, { href: "/world/regions/ashlands", label: "Ashlands biome guide" }],
  "/tools/console-commands": [{ href: "/servers/server-settings", label: "Server settings generator" }, { href: "/servers/dedicated-server-setup", label: "Dedicated server setup" }, { href: "/progression/roadmap", label: "Progression roadmap" }],
